...
describe "food_trucks/new" do
  before(:each) do
    assign(:food_truck, stub_model(FoodTruck,
      :truck_name => "MyString",
      :first_name => "MyString",
      :last_name => "MyString",
      :phone => "MyString",
  ...
  it "renders new food_truck form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => food_trucks_path, :method => "post" do
